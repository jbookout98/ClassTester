...
public:
    ...
    bool Initialize()
    {
        const char* filename = "C:\\Users\\Joshua\\Documents\\Project\\IndepedentStudyStuff\\Brainy Aliens\\params.ini";

        if (!LoadInParameters(filename))
        {
            MessageBox(NULL, "Cannot find Brainy Aliens\params.ini", "Error", 0);
